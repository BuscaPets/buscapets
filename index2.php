...
<section class="projects" id="projects">
   ...
   <div class="box-container">
      ...
      <div class="galeria">
         <img src="imgs/equipe/Alison.jpg" alt="">
         <div class="desc">
            <h3>Alison</h3>
         </div>
      </div>
         ...
         <div class="galeria">
            <img class="image-2" src="imgs/equipe/Beatriz.jpg" alt="">
            <div class="desc" style="position:relative; top:-68px">
               <h3>Beatriz</h3>
            </div>
         </div>

         <div class="galeria">
            <img src="imgs/equipe/Luis.jpg" style="height: 250px;position: relative; top: -17px">
            <div class="desc" style="position:relative;top:-56px;">
               <h3>Luís Miguel</h3>
            </div>
         </div>

         <div class="galeria">
            <img  src="imgs/equipe/Maria.jpg" style="width: 83%;">
            <div class="desc" style="position:relative; top:-30px;">
               <h3>Maria Luísa</h3>
            </div>
         </div>

      <div class="galeria" style="position: relative;left: 244px; top: 6px">
      ...
      <div class="galeria" style="position: relative;left: 244px;">
         <img src="imgs/equipe/Patricia.jpg" alt="">
         <div class="desc" style="position:relative; top:-12px;">
            <h3>Patrícia</h3>
         </div>
      </div>
      ...
      <div class="galeria" style="position: relative;left: 244px;">
         ...
         <div class="desc" style="position:relative; top:-40px;">
            <h3>Sofia</h3>
         </div>
      </div>
